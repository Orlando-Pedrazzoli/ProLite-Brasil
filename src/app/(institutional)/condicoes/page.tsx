...
export const metadata: Metadata = {
  ...
  description:
    'Condições da Pro-Lite: 10% de desconto no PIX e boleto, frete grátis acima de R$ 399 para todo o Brasil e parcelamento em até 10x sem juros no cartão.',
};
  ...
  return (
    <div className='max-w-4xl mx-auto px-4 py-10'>
      ...
      <div className='flex flex-wrap gap-2 mb-10'>
        ...
        <a
          href='#frete-gratis'
          className='text-sm px-3 py-1.5 rounded-full bg-brand/10 text-brand border border-brand/20 hover:bg-brand/20 transition-colors'
        >
          Frete Grátis
        </a>
        <a
        ...
        >
          ...
          <div className='space-y-4 text-gray-700 leading-relaxed'>
            <p>
              ...
              transportadora é sempre escolhida pela Pro-Lite.
            </p>
            <p>
