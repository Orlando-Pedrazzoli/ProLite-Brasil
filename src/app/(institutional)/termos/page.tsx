...
export const metadata: Metadata = {
  title: 'Termos de Uso',
  description:
    'Termos de Uso da loja virtual Pro-Lite. Conheça as regras e condições para compras em nosso e-commerce.',
};
    ...
    <div className='max-w-4xl mx-auto px-4 py-10'>
      ...
      <div className='prose prose-gray max-w-none space-y-6 text-gray-700 leading-relaxed'>
        ...
        <p>
          ...
          A Pro-Lite reserva-se o direito de alterar estes Termos a qualquer
          momento, sendo que a versão atualizada será sempre publicada nesta
          página.
        </p>
        ...
        <p>
          Todos os produtos comercializados na Pro-Lite são originais, de
          procedência legal, adquiridos e revendidos com nota fiscal e garantia
          do fabricante. Os preços dos produtos podem ser alterados a qualquer
          momento sem aviso prévio, sendo válido o preço vigente no momento da
        ...
        <p>
          A Pro-Lite oferece as seguintes formas de pagamento: cartão de crédito
          (parcelamento em até 10x sem juros), boleto bancário e PIX. Pagamentos
          via PIX e boleto bancário contam com desconto de 10% sobre o valor
          total do pedido. A confirmação do pedido está condicionada à aprovação
        ...
        <p>
          ...
          A Pro-Lite não se responsabiliza por atrasos causados pelas
        ...
        <p>
          A política de trocas e devoluções da Pro-Lite segue as disposições do
          Código de Defesa do Consumidor (Lei nº 8.078/90). O cliente tem o
          direito de solicitar a troca ou devolução do produto em até 7 (sete)
          dias corridos após o recebimento, desde que o produto esteja em sua
          embalagem original, sem sinais de uso e acompanhado da nota fiscal.
        ...
        <p>
          ...
          modificação do conteúdo sem autorização prévia por escrito.
        </p>
        ...
        <p>
          A Pro-Lite não se responsabiliza por eventuais indisponibilidades
          temporárias do site, causadas por manutenção, falhas técnicas ou
          eventos de força maior. Também não nos responsabilizamos por danos
          decorrentes do uso inadequado do site pelo usuário ou por informações
          incorretas fornecidas durante o cadastro ou processo de compra.
        </p>
        ...
        <p>
          A Pro-Lite compromete-se com a proteção dos dados pessoais dos seus
          usuários, em conformidade com a Lei Geral de Proteção de Dados (LGPD —
          Lei nº 13.709/2018). Para informações detalhadas sobre como coletamos,
        ...
        <p>
          O usuário autoriza expressamente a Pro-Lite a comunicar-se através de
          todos os canais de contato disponibilizados no cadastro, incluindo
          e-mail, SMS e WhatsApp, para fins relacionados a pedidos, suporte e
