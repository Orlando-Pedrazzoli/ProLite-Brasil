...
export const metadata: Metadata = {
  ...
  description:
    'Política de Privacidade da Pro-Lite. Saiba como protegemos seus dados pessoais e garantimos a segurança das suas informações.',
};
    ...
    <div className='max-w-4xl mx-auto px-4 py-10'>
      ...
      <div className='prose prose-gray max-w-none space-y-6 text-gray-700 leading-relaxed'>
        <p className='text-lg font-medium text-gray-900'>
          A Pro-Lite respeita o sigilo das suas informações e está comprometida
          com a proteção dos seus dados pessoais.
        </p>
        ...
        <p>
          A Pro-Lite reserva-se o direito de alterar esta Política de
