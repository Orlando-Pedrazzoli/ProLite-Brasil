...
export const metadata: Metadata = {
  ...
  description:
    'Conheça as formas de pagamento aceitas pela Pro-Lite: cartão de crédito em até 10x sem juros, PIX com 10% de desconto e boleto bancário.',
};
    ...
    <div className='max-w-4xl mx-auto px-4 py-10'>
      ...
      <div className='space-y-6'>
        ...
        <div className='bg-white rounded-lg shadow-sm p-6'>
          ...
          <div className='space-y-4 text-gray-700 leading-relaxed'>
            <p>
              ...
              essas informações por parte da Pro-Lite.
            </p>
        ...
        <div className='bg-white rounded-lg shadow-sm p-6'>
          ...
          <div className='space-y-4 text-gray-700 leading-relaxed'>
            <p>
              Todas as transações realizadas na Pro-Lite são processadas pela{' '}
              <strong>Pagar.me</strong>, uma das maiores empresas de meios de
              pagamento do Brasil, garantindo total segurança e criptografia dos
              seus dados.
            </p>
