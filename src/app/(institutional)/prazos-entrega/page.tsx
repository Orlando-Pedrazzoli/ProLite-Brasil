...
export const metadata: Metadata = {
  ...
  description:
    'Informações sobre prazos de entrega, frete grátis e serviço de envio da Pro-Lite. Entregamos em todo o Brasil.',
};
      ...
      <div className='space-y-8'>
        ...
        <div className='bg-white rounded-lg shadow-sm p-6'>
          ...
          <p className='text-gray-700 leading-relaxed mb-6'>
            A Pro-Lite oferece <strong>Frete Grátis</strong> para todo o Brasil
            em compras a partir de <strong>R$ 200,00</strong> para as regiões
            Sul e Sudeste, e acima de <strong>R$ 300,00</strong> para as regiões
