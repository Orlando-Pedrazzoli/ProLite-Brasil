# 🏄 Pro-Lite — E-commerce de Surf

## Resumo do Projeto

E-commerce completo de equipamentos de surf inspirado na [OnlySurf](https://www.onlysurf.com.br/), construído como **monorepo Next.js** com TypeScript. O projeto é um clone visual + funcional da OnlySurf para o cliente **Pro-Lite**.

- **Cliente:** Pro-Lite (novo cliente — loja física com 20 anos de mercado)
...
- [x] MongoDB Atlas conectado (cluster0.njxz6k3.mongodb.net/prolite-brasil)
...
```env
MONGODB_URI=mongodb+srv://pedrazzoliorlando:***@cluster0.njxz6k3.mongodb.net/prolite-brasil?appName=Cluster0
...
Clone visual da [OnlySurf](https://www.onlysurf.com.br/) adaptado para Pro-Lite:
